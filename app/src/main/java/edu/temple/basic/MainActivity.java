...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, NfcAdapter.CreateNdefMessageCallback {
    ...
    /**
     * Test: Can I do the entire app on one screen?
     * Answer: yes. do that.
     */
    ...
    private String setMessage() {
        ...
        String encryptedMessage = mService.encrypt(message, selectedFriend);
    ...
    private void acceptMessage(JSONObject json) {
        ...
        try {
            ...
            String decryptedMessage = mService.decrypt(encryptedMessage);
